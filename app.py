...
def startup() -> None:
    global settings, state, manager, nifty_manager, banknifty_manager, sensex_manager, nifty500_manager, niftymidcap100_manager, niftysmallcap100_manager, finnifty_manager, indiavix_manager, niftyit_manager, niftyauto_manager, niftypharma_manager, niftymetal_manager, niftyfmcg_manager, config_error
    config_error = ""
    try:
...
def shutdown() -> None:
    global manager, nifty_manager, banknifty_manager, sensex_manager, nifty500_manager, niftymidcap100_manager, niftysmallcap100_manager, finnifty_manager, indiavix_manager, niftyit_manager, niftyauto_manager, niftypharma_manager, niftymetal_manager, niftyfmcg_manager
    for name in ("niftyfmcg_manager", "niftymetal_manager", "niftypharma_manager", "niftyauto_manager", "niftyit_manager", "indiavix_manager", "finnifty_manager", "niftysmallcap100_manager", "niftymidcap100_manager", "nifty500_manager", "sensex_manager", "banknifty_manager", "nifty_manager", "manager"):
