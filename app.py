...
settings = state = manager = nifty_manager = banknifty_manager = sensex_manager = nifty_options_manager = nifty_depth_manager = banknifty_options_manager = banknifty_depth_manager = None
...
def startup() -> None:
    global settings, state, manager, nifty_manager, banknifty_manager, sensex_manager, nifty_options_manager, nifty_depth_manager, banknifty_options_manager, banknifty_depth_manager, nifty500_manager, niftymidcap100_manager, niftysmallcap100_manager, finnifty_manager, indiavix_manager, niftyit_manager, niftyauto_manager, niftypharma_manager, niftymetal_manager, niftyfmcg_manager, niftyrealty_manager, niftyenergy_manager, niftyinfra_manager, config_error
    config_error = ""
    try:
...
def shutdown() -> None:
    global manager, nifty_manager, banknifty_manager, sensex_manager, nifty_options_manager, nifty_depth_manager, banknifty_options_manager, banknifty_depth_manager, nifty500_manager, niftymidcap100_manager, niftysmallcap100_manager, finnifty_manager, indiavix_manager, niftyit_manager, niftyauto_manager, niftypharma_manager, niftymetal_manager, niftyfmcg_manager, niftyrealty_manager, niftyenergy_manager, niftyinfra_manager
    for name in ("banknifty_depth_manager","banknifty_options_manager","nifty_depth_manager","nifty_options_manager","niftyinfra_manager","niftyenergy_manager","niftyrealty_manager","niftyfmcg_manager","niftymetal_manager","niftypharma_manager","niftyauto_manager","niftyit_manager","indiavix_manager","finnifty_manager","niftysmallcap100_manager","niftymidcap100_manager","nifty500_manager","sensex_manager","banknifty_manager","nifty_manager","manager"):
